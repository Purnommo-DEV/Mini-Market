<div class="active tab-pane" id="pesananBerhasil">
    @foreach($pesanan as $pesanans)
    @if ($pesanans->status_pesanan == "Terkirim" || $pesanans->status_pesanan == "Diterima")
    ...
    <div class="accordion accordion-icon" id="accordion-3">
        <div class="card">
                ...
                <div class="card-body">
                <h6 class="card-title" style="color: cornflowerblue;">Status : {{ $pesanans->status_pesanan }}</h6>
                <p class="card-text">Konfirmasi di Terima : {{ $pesanans->updated_at->diffForHumans() }} ({{ $pesanans->updated_at->toFormattedDateString()}})</p>
                </div>
            </a>
            </div>
                ...
                <div class="entry-item lifestyle shopping col-sm-12">
                    <div class="entry-body">
                        <table class="table table-striped table-bordered text-center">
                            ...
                            <tr>
                                <td>Alamat</td>
                                <td>{{$pesanans->user->alamat}}, {{$pesanans->user->kota->name}},{{$pesanans->user->provinsi->name}},
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
