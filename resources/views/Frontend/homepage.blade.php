...
<section class="hero-slider">
    <!-- Single Slider -->
    <div class="single-slider" style="background-image: url('{{asset('Admin/gambar/gambar_slider')}}/{{ $data_slider->gambar_slider }}');">
        <div class="container">
                    ...
                    <div class="text-inner">
                        <div class="row">
                            <div class="col-lg-7 col-12">
                                <div class="hero-text">
                                    <h1><span>{{ $data_slider->judul }}</h1>
                                    <p>{{ $data_slider->deskripsi }}</p>
                                    <div class="button">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="product-info">
                        ...
                        <div class="row align-items-center" style="justify-content: center;">
                            <a style="background: darkgray;border-radius: 30px;" href="{{ route('SemuaProduk') }}" class="btn wow fadeInUp" data-wow-delay=".8s">Semua Produk</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(".tambahKeKeranjangBtn").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    tampilProdukKeranjatampilProdng();tampilProd
                }
            });
        });
    });
