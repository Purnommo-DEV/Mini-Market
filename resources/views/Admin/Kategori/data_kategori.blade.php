                                            ...
                                            <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 pr-0">
                                                            <div class="form-group form-group-default">
                                                                <label>Gambar</label>
                                                                <input type="file" class="form-control" name="gambar_kategori" accept="image/png, image/jpeg" placeholder="Gambar">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <table id="kategoris" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        @foreach ($data_kategori as $data_kategoris)
                                            <tr>
                                                <td>{{$data_kategoris->nama_kategori}}</td>
                                                <td><img src="{{ asset('Admin/gambar/gambar_kategori') }}/{{ $data_kategoris->gambar_kategori }}" width="100" alt="Tidak Ada Gambar"></td>
                                                <td>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>Nama Kategori</label>
                                                                            <input name="nama_kategori" value="{{ $data_kategoris->nama_kategori }}" type="text"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group form-group-default">
                                                                            <label>Gambar</label>
                                                                            <input name="gambar_kategori" type="file" accept="image/png, image/jpeg" value="{{ $data_kategoris->gambar_kategori }}"
                                                                                class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </div>
